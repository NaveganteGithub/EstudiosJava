package paso2_Avanzados.concepto10_Recursos;

import java.util.Random;

import paso2_Avanzados.concepto09_POO.concepto01_Basico.explicacion_documentada.CalculosFechas;

public class Diferenciar {

	public static void main(String[] args) {
		
		// Diferenciar entre una clase y array
